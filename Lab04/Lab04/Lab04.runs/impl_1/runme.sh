...
HD_PWD='C:/Users/fowlersp/Documents/ECE_212_Lab_Fowler_Nosow/Lab04/Lab04/Lab04.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_temp_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clk_temp_top.tcl -notrace
