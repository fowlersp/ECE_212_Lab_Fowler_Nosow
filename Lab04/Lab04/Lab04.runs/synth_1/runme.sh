...
HD_PWD='C:/Users/fowlersp/Documents/ECE_212_Lab_Fowler_Nosow/Lab04/Lab04/Lab04.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_temp_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_temp_top.tcl
